...
def write_image_output(output_img, content_img, style_imgs, init_img):
  ...
  img_path = os.path.join(out_dir, args.img_name+'.mat')
  content_path = os.path.join(out_dir, 'content.mat')
  init_path = os.path.join(out_dir, 'init.mat')

  write_image(img_path, output_img)
  write_image(content_path, content_img)
  write_image(init_path, init_img)
  path = os.path.join(out_dir, 'style.mat')
  write_image(path, style_imgs)
  ...
  f.write('styles: {} * {}\n'.format(args.style_imgs_weights, args.style_imgs))
...
def get_content_image():
  img = os.path.join(args.content_img_dir, args.content_img)
  return img

def get_style_images():
  style_imgs = os.path.join(args.style_imgs_dir,args.style_imgs[0])
  return style_imgs
...
def render_single_image():
  content_img = get_content_image()
  style_imgs = get_style_images()
